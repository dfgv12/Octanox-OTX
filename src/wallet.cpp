...
// octanox: total coins staked (non-spendable until maturity)
...
// Octanox: get current stake weight
...
// octanox: check 'spent' consistency between wallet and txindex
// octanox: fix wallet spent state according to txindex
...
// octanox: disable transaction (only for coinstake)
